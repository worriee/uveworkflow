...
- Rule Folder Isolation: BAN create files in `.clinerules/rules/`. Only use existing memory files.
...
- Zero-Tolerance Tampering: BAN edit/delete `.clinerules/rules/` or `.clinerules/skills/` files (`system_instructions.md`, `.clinerules`, `skills/*/SKILL.md`).
