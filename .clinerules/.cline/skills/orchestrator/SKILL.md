...
- Refer to `.clinerules/.cline/skills/planner/SKILL.md` (flag: `-p`).
...
- Log the approved plan to `.clinerules/memory/implementation_memory.md`.

### Stage 2: CODE

- Refer to `.clinerules/.cline/skills/coder/SKILL.md` (flag: `-c`).
...
- Refer to `.clinerules/.cline/skills/tester/SKILL.md` (flag: `-t`).
...
- Refer to `.clinerules/.cline/skills/debugger/SKILL.md` (flag: `-d`).
...
- Refer to `.clinerules/.cline/skills/secure/SKILL.md` (flag: `-s`).
...
- Refer to `.clinerules/.cline/skills/reviewer/SKILL.md` (flag: `-r`).
...
- Write a structured summary to `.clinerules/memory/implementation_memory.md`.
...
- Update `.clinerules/project_memory.md` with completed milestones.
...
- Monitor task progress by cross-referencing `.clinerules/project_memory.md`.
- Track bugs in `.clinerules/memory/error_memory.md`.
- Track security findings in `.clinerules/memory/security_memory.md`.
- Track review findings in `.clinerules/memory/review_memory.md`.
- Track test strategies in `.clinerules/memory/test_memory.md`.
