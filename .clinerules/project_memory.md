...
All specialized memory logs are stored in `.clinerules/memory/` directory:

- **Error Memory**: `.clinerules/memory/error_memory.md` — Active bugs, stack traces, resolution history
- **Codebase Map**: `.clinerules/memory/codebase_map.md` — Directory structure, file purposes, dependency mapping
- **Implementation Memory**: `.clinerules/memory/implementation_memory.md` — Architectural design maps, feature flows, execution roadmaps
- **Security Memory**: `.clinerules/memory/security_memory.md` — Vulnerability tracking, threat modeling, remediation plans
...
- **Archive Location**: `.clinerules/archives/`
