...
- Rule Folder Isolation: BAN create files in `.roo/rules/`. Only use existing memory files.
...
- Zero-Tolerance Tampering: BAN edit/delete `.roo/rules/` or `.roo/skills/` files (`system_instructions.md`, `.clinerules`, `skills/*/SKILL.md`).
