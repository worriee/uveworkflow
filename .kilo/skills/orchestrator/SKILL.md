...
3. **State Integration**: Monitor task progress by cross-referencing completed sub-tasks against the project's state memory (`.kilo/rules/project_memory.md`) and ongoing bugs tracked in (`.kilo/rules/error_memory.md`).
