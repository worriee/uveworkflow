...
- Refer to `.kilo/skills/planner/SKILL.md` (flag: `-p`).
...
- Log the approved plan to `.kilo/memory/implementation_memory.md`.

### Stage 2: CODE

- Refer to `.kilo/skills/coder/SKILL.md` (flag: `-c`).
...
- Refer to `.kilo/skills/tester/SKILL.md` (flag: `-t`).
...
- Refer to `.kilo/skills/debugger/SKILL.md` (flag: `-d`).
...
- Refer to `.kilo/skills/secure/SKILL.md` (flag: `-s`).
...
- Refer to `.kilo/skills/reviewer/SKILL.md` (flag: `-r`).
...
- Write a structured summary to `.kilo/memory/implementation_memory.md`.
...
- Update `.kilo/rules/project_memory.md` with completed milestones.
...
- Monitor task progress by cross-referencing `.kilo/rules/project_memory.md`.
- Track bugs in `.kilo/memory/error_memory.md`.
- Track security findings in `.kilo/memory/security_memory.md`.
- Track review findings in `.kilo/memory/review_memory.md`.
- Track test strategies in `.kilo/memory/test_memory.md`.
