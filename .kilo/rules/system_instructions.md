...
- Rule Folder Isolation: BAN create files in `.kilo/rules/`. Only use existing memory files.
...
- Zero-Tolerance Tampering: BAN edit/delete `.kilo/rules/` or `.kilo/skills/` files (`system_instructions.md`, `.clinerules`, `skills/*/SKILL.md`).
