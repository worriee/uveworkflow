...
5. **Security Memory Synchronization**: You are authorized to write structural summaries of active vulnerabilities and attack flows directly into `.opencode/memory/security_memory.md` using the strict LIFO format for these logs.
