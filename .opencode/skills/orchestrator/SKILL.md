...
3. **State Integration**: Monitor task progress by cross-referencing completed sub-tasks against the project's state memory (`.opencode/rules/project_memory.md`) and ongoing bugs tracked in (`.opencode/memory/error_memory.md`).
