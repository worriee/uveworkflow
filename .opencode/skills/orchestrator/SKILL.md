...
- Refer to `.opencode/skills/planner/SKILL.md` (flag: `-p`).
...
- Log the approved plan to `.opencode/memory/implementation_memory.md`.

### Stage 2: CODE

- Refer to `.opencode/skills/coder/SKILL.md` (flag: `-c`).
...
- Refer to `.opencode/skills/tester/SKILL.md` (flag: `-t`).
...
- Refer to `.opencode/skills/debugger/SKILL.md` (flag: `-d`).
...
- Refer to `.opencode/skills/secure/SKILL.md` (flag: `-s`).
...
- Refer to `.opencode/skills/reviewer/SKILL.md` (flag: `-r`).
...
- Write a structured summary to `.opencode/memory/implementation_memory.md`.
...
- Update `.opencode/rules/project_memory.md` with completed milestones.
...
- Monitor task progress by cross-referencing `.opencode/rules/project_memory.md`.
- Track bugs in `.opencode/memory/error_memory.md`.
- Track security findings in `.opencode/memory/security_memory.md`.
- Track review findings in `.opencode/memory/review_memory.md`.
- Track test strategies in `.opencode/memory/test_memory.md`.
