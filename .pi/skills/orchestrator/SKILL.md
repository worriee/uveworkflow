...
- Refer to `.pi/skills/planner/SKILL.md` (flag: `-p`).
...
- Log the approved plan to `.pi/memory/implementation_memory.md`.

### Stage 2: CODE

- Refer to `.pi/skills/coder/SKILL.md` (flag: `-c`).
...
- Write a structured summary to `.pi/memory/implementation_memory.md`.
...
- Update `.pi/rules/project_memory.md` with completed milestones.
...
- Monitor task progress by cross-referencing `.pi/rules/project_memory.md`.
- Track bugs in `.pi/memory/error_memory.md`.
- Track security findings in `.pi/memory/security_memory.md`.
- Track review findings in `.pi/memory/review_memory.md`.
- Track test strategies in `.pi/memory/test_memory.md`.
